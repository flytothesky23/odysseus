...
const _LABELS = {
  ...
  'vault-explorer-panel': { label: 'Explorer', icon: '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>' },
...
const _AUTO_WIRE = {
  ...
  'vault-explorer-panel': { rail: 'rail-vault-explorer', sidebar: 'tool-vault-explorer-btn' },
